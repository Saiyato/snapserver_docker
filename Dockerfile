...
# Install dependencies for snapweb
RUN apk -U add npm \
 && npm install -g typescript@latest
# Download and build snapweb
...
# Cleanup
RUN apk --purge del alsa-lib-dev avahi-dev bash build-base ccache cmake expat-dev flac-dev git libvorbis-dev opus-dev soxr-dev \
